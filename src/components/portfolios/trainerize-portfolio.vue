<template>
  <div id="trainerize-portfolio" class="portfolio-wrapper">
    <div v-show="showContent">
        ...
        <div class="container">
          ...
          <div class="row align-items-lg-center">
            ...
            <div class="col-12 col-lg-8 full-img-wrapper">
              <img class="foo2" src="./../../assets/portfolios/trainerize/trz-dashboard.svg" alt="trainerize-dashborad">
            </div>
          </div>
      ...
      <section id="trz-system-overview" class="trainerize-dark-bcg">
        <div class="container">
          <div class="row">
            <div class="col-12 top-wrapper text-center">
              <h2 class="portfolio-section-main-title text-center">System overview</h2>
              <img src="./../../assets/portfolios/trainerize/trz-system-overview-top.svg" alt="">
            </div>
          </div>
          <div class="row flex-lg-row-reverse align-items-lg-center section-item-lg-margin-top">
            <div class="col-12 col-lg-4">
              <img src="./../../assets/portfolios/trainerize/trz-system-overview-graph.svg" class="d-none d-lg-block margin-bottom-40" alt="">
              <h3 class="portfolio-section-title text-white margin-lg-0">Clients timeline</h3>
              <p class="portfolio-section-text text-grey-9c">
                These views serve to get understanding of the overall progress of the set training plan.
                The timeline is also an overview of all activities, communication with the trainer and meal plans.
              </p>
            </div>
            <div class="col-12 col-lg-8 text-center">
              <img class="foo6" src="./../../assets/portfolios/trainerize/trz-system-overview-phones.svg" alt="">
            </div>
          </div>
          <div class="row">
            <div class="col-12 text-center">
          ...
          <div class="row align-items-lg-center section-item-lg-margin-top">
            ...
            <div class="col-12 col-lg-8 text-center">
              <img class="foo8" src="./../../assets/portfolios/trainerize/trz-system-overview-screens.svg" alt="">
            </div>
          </div>
          <div class="row flex-lg-row-reverse align-items-lg-center section-item-lg-margin-top">
          ...
          <div class="row align-items-lg-center section-item-lg-margin-top">
            ...
            <div class="col-12 col-lg-7 offset-lg-1 full-img-wrapper text-center">
              <img class="foo10" src="./../../assets/portfolios/trainerize/trz-system-overview-bottom.svg" alt="">
            </div>
          </div>
        </div>
      </section>
